...
link1 = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/OnKfrQrEOrk" allowfullscreen></iframe></div>'
link2 = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Hs9npUUIg4I" allowfullscreen></iframe></div>'
talking = true; 
...
if (lastUserMessage === '1.1'){
  botMessage = link1 +"press * to return to the previous menu.";
}

if (lastUserMessage === '1.2') {
  botMessage = link2 +"press * to return to the previous menu.";
}
